...
from PyQt5.QtWidgets import QWidget, QApplication, QLabel,QGridLayout,QCheckBox,QMenu, QVBoxLayout, QHBoxLayout, \
     QGroupBox, QLineEdit, QPushButton, QTextEdit, QComboBox, QSlider, QInputDialog, QMessageBox, QListWidget, QListWidgetItem, QTableWidget, QTableWidgetItem
from PyQt5.QtGui import QPixmap,QImage,QColor, QWindow, QFont
...
class Ui_SensorDialog(QWidget):
    ...
    def initUI(self):
        ...
        self.motionList.itemClicked.connect(self.execute_Fixed_Gun_Motion_Test)
